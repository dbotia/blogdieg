...
describe('Entry e2e test', () => {
    ...
    it('should load Entries', () => {
        ...
        expect(entryComponentsPage.getTitle()).toMatch(/blogdiegApp.entry.home.title/);
    ...
    it('should load create Entry dialog', () => {
        ...
        expect(entryDialogPage.getModalTitle()).toMatch(/blogdiegApp.entry.home.createOrEditLabel/);
