...
import com.udea.app.BlogdiegApp;
import com.udea.app.domain.Authority;
import com.udea.app.domain.User;
import com.udea.app.repository.AuthorityRepository;
...
import com.udea.app.web.rest.errors.ExceptionTranslator;
import com.udea.app.web.rest.vm.KeyAndPasswordVM;
import com.udea.app.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = BlogdiegApp.class)
